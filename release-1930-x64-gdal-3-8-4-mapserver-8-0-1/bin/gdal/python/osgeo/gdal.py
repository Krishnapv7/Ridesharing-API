...
def GetGlobalConfigOption(*args) -> "char const *":
...
def GetConfigOptions(*args) -> "char **":
...
def FileFromMemBuffer(*args) -> "VSI_RETVAL":
...
class Group(object):
    ...
    def DeleteGroup(self, *args) -> "CPLErr":
    ...
    def DeleteMDArray(self, *args) -> "CPLErr":
    ...
    def DeleteAttribute(self, *args) -> "CPLErr":
    ...
    def SubsetDimensionFromSelection(self, *args) -> "GDALGroupHS *":
...
class MDArray(object):
    ...
    def GetTotalElementsCount(self, *args) -> "GUIntBig":
...
class Dimension(object):
    ...
    def GetSize(self, *args) -> "GUIntBig":
...
class SubdatasetInfo(object):
    ...
    def ModifyPathComponent(self, *args) -> "retStringAndCPLFree *":
...
def GetSubdatasetInfo(*args) -> "GDALSubdatasetInfoShadow *":
...
class SuggestedWarpOutputRes(object):
    ...
    def GetGeotransform(self, *args) -> "void":
...
def SuggestedWarpOutputFromTransformer(*args) -> "SuggestedWarpOutputRes *":
...
def SuggestedWarpOutputFromOptions(*args) -> "SuggestedWarpOutputRes *":
...
def wrapper_GDALFootprintDestDS(*args) -> "int":
...
def wrapper_GDALFootprintDestName(*args) -> "GDALDatasetShadow *":
